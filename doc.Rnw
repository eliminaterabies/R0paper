...
<<<<<<< HEAD
The data set contains \Sexpr{dogsTransmissionNum} domestic dog recorded events (i.e., domestic dogs bitten by an animal) from Serengeti District of northern Tanzania.
=======
The data set contains \Sexpr{biteEvents} domestic dog recorded events (i.e., domestic dogs bitten by an animal), and \Sexpr{suspectedNum} suspected rabid dogs in the Serengeti District of northern Tanzania.
>>>>>>> 83e52b77b56c66b29a757c373819bd83ebed2113
...
We restricted our analysis to domestic dog transmissions (i.e., dog to dog) \mli{x linked transmissions and of those yy are biters and non-biters}.
, and obtained \Sexpr{GIcount} directly observed generation intervals (i.e. both biter and secondary case have ``time bitten" records).
